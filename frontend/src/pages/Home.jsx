  ...
  return (
    <div className="min-h-screen overflow-hidden bg-white text-black">
      ...
      <section className="max-w-7xl mx-auto px-8 pt-32 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        <div>
          <motion.div
            intial={{ opacity: 0, x: -60 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.7 }}
            whileHover={{ rotateX: 6, rotateY: -6 }}
            className="transform-gpu"
            style={{ transformStyle: "preserver-3d" }}
          >
            <motion.h1
              whileHover={{ y: -4 }}
              style={{
      ...
      {/* bottom */}
      <section className="max-w-8xl lg:max-w-7xl mx-auto px-8 py-32 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-10 ">
        <Feature
          icon={"📘"}
          title={"Exam Notes"}
        ...
        <Feature
          icon={"📊"}
          title={"Diagrams"}
          des={"Auto-generate visual diagrams for clarity."}
        />
        <Feature
          icon={"⬇️"}
          title={"PDF Download"}
