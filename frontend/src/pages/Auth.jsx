  ...
  return (
    <div className="min-h-screen overflow-hidden bg-white text-black px-8 ">
      ...
      <main className="max-w-7xl mx-auto py-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center ">
        ...
        >
          <h1 className="text-5xl lg:text-6xl font-extrabold leading-tight bg-linear-to-br from-black via-black/60 to-black/90 bg-clip-text text-transparent ">
          ...
          disabled={click}
            ...
            className={`mt-10 px-10 py-3 rounded-xl flex items-center gap-3 bg-linear-to-br from-black/90 via-black/80 to-black/90 border border-white/10 text-white font-semibold text-lg shadow-[0_25px_60px_rgba(0,0,0,0.7)] cursor-pointer  ${click ? "opacity-50 cursor-not-allowed" : "cursor-pointer"} `}
          >
            <FcGoogle size={22} /> {click ? "Signing in..." : "Continue with Google"}
          </motion.button>

          <p className="mt-6 max-w-xl text-lg bg-linear-to-br from-gray-700 via-gray-500/50 to-gray-700 bg-clip-text text-transparent">
        ...
        <motion.div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          <Feature
            ...
            des={
              "Start with 50 credits to generate notes without without paying."
            }
          />
          <Feature
            icon="📘"
